package ruan.finalproject.view;
...
import ruan.finalproject.AudioOb;
import ruan.finalproject.Music_Player;
...
import ruan.finalproject.util.UtilTime;
...
public class PlayView extends LinearLayout implements MusicController.IPlayerStatus {
    ...
    public PlayView(Context context) {
        super(context);
        this.mContext = (Music_Player) context;
