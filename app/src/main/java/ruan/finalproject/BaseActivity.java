...
public class BaseActivity extends AppCompatActivity {
    ...
    public void toActivity(Class name, Bundle bundle){
    ...
    public void toActivity(Class name, String key, int value){
        Intent intent = new Intent(this,name);
    ...
    public void toActivity(Class name, String key, String value){
        Intent intent = new Intent(this,name);
